...
for (let pokemon of pokemons) {
    ...
    pokemonsName.setAttribute("class", "text-dark")
    ...
    cardDiv.appendChild(pokemonsName)
    cardDiv.appendChild(pokemonsType)
    cardDiv.appendChild(pHeight)
    cardDiv.appendChild(pWeight)
    cardDiv.appendChild(heartImg)
}